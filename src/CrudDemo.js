...
const baseURL = "http://localhost:8080/api/v2/persons";
  ...
  const Form = () => {
    ...
    return (
      <form
        ...
        onSubmit={handleSubmit(savePerson)}
      >
...
export const PersonDetails = () => {
  ...
  return (
    <div className="card m-2" style={{ width: 500 }}>
      <div className="card-header bg-info text-white">Details</div>
      <div className="card-body">
      ...
      <div className="card-footer bg-dark">
        <Link className="btn btn-outline-danger" to="/crud">
          Back
        </Link>
      </div>
    </div>
